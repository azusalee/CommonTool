...
extension UIScrollView {
    ...
    func al_addKeyboardNotification() {
        //NotificationCenter.default.addObserver(self, selector: #selector(UIScrollView.keyboardWillAppear(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
